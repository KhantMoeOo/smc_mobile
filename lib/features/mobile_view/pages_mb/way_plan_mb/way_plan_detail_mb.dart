...
import '../../../../pages/way_planning_page/way_planning_delete_bloc.dart';
...
import 'way_plan_list_mb.dart';

class WayPlanningDetailMB extends StatefulWidget {
  int wayplanid;
  String tripId;
  List<dynamic> name;
  List<dynamic> zoneId;
  ...
  @override
  State<WayPlanningDetailMB> createState() => _WayPlanningDetailMBState();
}

class _WayPlanningDetailMBState extends State<WayPlanningDetailMB>
