...
class DeliveryDetailMB extends StatefulWidget {
  int quotationId;
  DeliveryDetailMB({
    Key? key,
  ...
  @override
  State<DeliveryDetailMB> createState() => _DeliveryDetailMBState();
}

class _DeliveryDetailMBState extends State<DeliveryDetailMB> {
