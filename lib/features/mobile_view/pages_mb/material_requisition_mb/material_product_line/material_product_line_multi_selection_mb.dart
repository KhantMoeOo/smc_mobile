...
class MaterialProductLineMultiSelectionMB extends StatefulWidget {
  int quotationId;
  int newOrEdit;
  int newOrEditSOL;
  int solId;
  ...
  String? taxesName;
  int? isFOC;
  MaterialProductLineMultiSelectionMB({
    Key? key,
  ...
  @override
  State<MaterialProductLineMultiSelectionMB> createState() =>
      _MaterialProductLineMultiSelectionMBState();
}

class _MaterialProductLineMultiSelectionMBState
    extends State<MaterialProductLineMultiSelectionMB> {
