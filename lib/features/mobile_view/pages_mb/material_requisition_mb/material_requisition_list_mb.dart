...
import '../../../../pages/material_requisition_page/material_requisition_detail_page.dart';
...
import 'material_requisition_detail_mb.dart';

class MaterialRequisitionListMB extends StatefulWidget {
  const MaterialRequisitionListMB({Key? key}) : super(key: key);

  @override
  State<MaterialRequisitionListMB> createState() =>
      _MaterialRequisitionListMBState();
}

class _MaterialRequisitionListMBState extends State<MaterialRequisitionListMB> {
                                                    ...
                                                    onTap: () {
                                                      Navigator.of(context).push(
                                                          MaterialPageRoute(
                                                              builder:
                                                                  (context) {
                                                        return MaterialRequisitionDetailMB(
