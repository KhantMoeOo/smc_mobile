...
import '../../../../pages/material_requisition_page/material_product_line_page/multi_material_product_line_page.dart';
...
class MaterialRequisitionCreateMB extends StatefulWidget {
  ...
  @override
  State<MaterialRequisitionCreateMB> createState() =>
      _MaterialRequisitionCreateMBState();
}

class _MaterialRequisitionCreateMBState
    extends State<MaterialRequisitionCreateMB> {
                                              ...
                                              child: TextButton(
                                                  ...
                                                  onPressed: () {
                                                    Navigator.of(context).push(
                                                        MaterialPageRoute(
                                                            builder: (context) {
                                                      return MaterialProductLineMultiSelectionMB(
                                                        newOrEditSOL: 0,
                                                        newOrEdit: 0,
                                                        quotationId: 0,
                                                        solId: 0,
