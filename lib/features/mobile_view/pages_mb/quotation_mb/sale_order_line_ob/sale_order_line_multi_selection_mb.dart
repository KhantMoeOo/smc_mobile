...
class SaleOrderLineMultiSelectionMB extends StatefulWidget {
  int quotationId;
  int newOrEdit;
  int newOrEditSOL;
  int solId;
  ...
  @override
  State<SaleOrderLineMultiSelectionMB> createState() =>
      _SaleOrderLineMultiSelectionMBState();
}

class _SaleOrderLineMultiSelectionMBState
    extends State<SaleOrderLineMultiSelectionMB> {
