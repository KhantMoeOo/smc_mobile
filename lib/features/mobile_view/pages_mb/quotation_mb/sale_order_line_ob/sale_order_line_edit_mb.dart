...
class SaleOrderLineEditMB extends StatefulWidget {
  int quotationId;
  int newOrEdit;
  int newOrEditSOL;
  int solId;
  ...
  @override
  State<SaleOrderLineEditMB> createState() => _SaleOrderLineEditMBState();
}

class _SaleOrderLineEditMBState extends State<SaleOrderLineEditMB> {
