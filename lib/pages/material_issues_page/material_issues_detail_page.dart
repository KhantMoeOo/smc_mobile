...
class MaterialIssuesDetailPage extends StatefulWidget {
  int id;
  MaterialIssuesDetailPage({
    Key? key,
    required this.id,
  }) : super(key: key);

  @override
  State<MaterialIssuesDetailPage> createState() =>
      _MaterialIssuesDetailPageState();
}

class _MaterialIssuesDetailPageState extends State<MaterialIssuesDetailPage> {
